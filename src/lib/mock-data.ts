...
export const CORPORATIONS: Corporation[] = [
  ...
  },
  {
    ...
    founded: 2011,
    description: "בית לעובדי גמר וטיח מהמובילים באזור ירושלים. דגש על עבודות איכות לפרויקטי יוקרה.",
    available: "available",
  },
];
    ...
    offers: [
      {
        ...
        warrantyDays: 30,
        insurance: true,
        note: "צוות שעבד יחד 4 שנים. ניסיון מוכח במגדלי מגורים.",
      },
      {
        ...
        warrantyDays: 60,
        insurance: true,
        note: "אפשרות לתגבור עד 12 עובדים בשבוע השני.",
      },
      {
        ...
        warrantyDays: 30,
        insurance: false,
        note: "צוות חלקי בלבד, יושלם תוך שבוע.",
      },
      {
        corporationId: "ort",
        pricePerHour: 205,
        ...
        warrantyDays: 45,
        insurance: true,
        note: "צוות בכיר עם מנהל עבודה צמוד.",
      },
    ],
  },
  {
