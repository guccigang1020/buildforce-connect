  ...
  <Html lang="he" dir="rtl">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <table style={table}>
          <tbody>
            {pricePerHour ? <tr><td style={tdLabel}>מחיר לשעה</td><td style={tdValue}>{pricePerHour} ₪</td></tr> : null}
            {workersCount ? <tr><td style={tdLabel}>עובדים זמינים</td><td style={tdValue}>{workersCount}</td></tr> : null}
        ...
        <Button style={button} href={requestId ? `${SITE_URL}/requests/${requestId}` : `${SITE_URL}/dashboard`}>צפה בהצעות</Button>
