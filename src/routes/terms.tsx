      ...
      <main className="mx-auto max-w-3xl px-4 py-12 md:py-16">
        ...
        <div className="prose prose-invert mt-8 max-w-none space-y-6 text-sm leading-7 text-foreground/90">
          ...
          <Section title="6. תקשורת מחוץ לפלטפורמה">
            <p>
              כל התקשורת בין קבלן לתאגיד לפני בחירת זוכה חייבת להתבצע בתוך הפלטפורמה בלבד. אסור לחלוטין: שיתוף מספרי טלפון, אימייל, קישורים, שמות משתמש או כל ערוץ חיצוני (WhatsApp, Telegram, Instagram וכד׳) בהודעות מכרז, וכן יצירת קשר ישיר מחוץ לפלטפורמה אחרי שאותרת זהות הצד השני דרך BuildForce.
            </p>
            <p className="mt-2">
              <strong>קנס בגין עקיפה:</strong> תאגיד שייצור קשר ישיר עם קבלן ויסגור עסקה מחוץ לפלטפורמה יחויב בקנס בגובה <strong>פי 12 מהעמלה החודשית הצפויה</strong> של אותו פרויקט (לפי מספר העובדים × ₪2 לשעה × 176 שעות חודשיות × 12), בנוסף להשעיה מיידית מהפלטפורמה ושיפוי על נזקים נוספים. קנס זה מהווה פיצוי מוסכם מראש לפי סעיף 15 לחוק החוזים (תרופות).
            </p>
            <p className="mt-2">
              BuildForce מנטרת אוטומטית את תוכן ההודעות, שומרת לוגים מלאים של גישה ופעולות, ורשאית להסתמך עליהם כראיה משפטית.
            </p>
          </Section>
          ...
          <Section title="7א. הגנות משפטיות נוספות">
            <ul className="mr-5 list-disc space-y-1">
              <li>BuildForce אינה צד לעסקה בין קבלן לתאגיד ואינה אחראית למחדלי תשלום, מסים, ביטוח לאומי או רישוי עובדים.</li>
              <li>שימוש בפלטפורמה כפוף להסכמה מפורשת בעת ההרשמה — לחיצה על "הרשמה" מהווה חתימה אלקטרונית מחייבת לפי חוק חתימה אלקטרונית, התשס״א-2001.</li>
              <li>התאגיד מצהיר שכל העובדים שיסופקו מועסקים על-ידו כדין, עם כל האישורים, הביטוחים והרישיונות הנדרשים.</li>
              <li>BuildForce רשאית לשנות, להשעות או להפסיק כל חשבון בכל עת, לרבות במקרי חשד להונאה, עקיפה, או הפרת תנאים — ללא צורך בהתראה מוקדמת.</li>
              <li>אחריותה הכוללת של BuldForce, אם תקום, מוגבלת לסכום העמלות ששולמו על ידי הצד התובע ב-12 החודשים שקדמו לעילת התביעה.</li>
            </ul>
          </Section>
